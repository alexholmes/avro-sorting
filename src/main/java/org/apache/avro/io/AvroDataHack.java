...
public class AvroDataHack {
     ...
     * org.apache.avro.generic.GenericData#compare(Object, Object, org.apache.avro.Schema)}.
     */
    public static int compare(byte[] b1, int s1, int l1,
                              byte[] b2, int s2, int l2,
                              Schema schema, FieldFetcher fetcher) {
    ...
    public static int compare(Decoders d, Schema schema, FieldFetcher fetcher) throws IOException {
        ...
        Map<Field, Integer> fieldComparables = new HashMap<Field, Integer>();
        Map<Field, Boolean> fieldAscending = new HashMap<Field, Boolean>();
    ...
    public static int hashCode(Object o, Schema s, FieldFetcher fetcher) {
        ...
        Set<Field> fieldComparables = new HashSet<Field>();
        for (OrderedField field : orderedFields) {
