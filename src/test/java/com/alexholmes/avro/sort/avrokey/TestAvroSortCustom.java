...
public class TestAvroSortCustom extends AbstractAvroTest {
    ...
    public void testAvroMapOutput() throws Exception {
        ...
        Assert.assertTrue(new AvroSortCustom().runMapReduce(job, inputPath, outputPath));
        ...
        super.assertOutputResults(job, outputPath, new WeatherNoIgnore[]{
                ...
                WeatherNoIgnore.newBuilder().setStation("SFO").setTime(1).setTemp(2).setCounter(2).build(),
                WeatherNoIgnore.newBuilder().setStation("SFO").setTime(1).setTemp(3).setCounter(3).build(),
