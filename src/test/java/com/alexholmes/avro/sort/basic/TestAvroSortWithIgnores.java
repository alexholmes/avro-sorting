...
public class TestAvroSortWithIgnores extends AbstractAvroTest {
    ...
    public void testAvroMapOutput() throws Exception {
        ...
        Assert.assertTrue(new AvroSortWithIgnores().runMapReduce(job, inputPath, outputPath));
        ...
        super.assertOutputResults(job, outputPath, new Weather[] {
                ...
                Weather.newBuilder().setStation("SFO").setTime(1).setTemp(3).setCounter(1).build(),
                Weather.newBuilder().setStation("SFO").setTime(1).setTemp(2).setCounter(1).build(),
                Weather.newBuilder().setStation("SFO").setTime(1).setTemp(1).setCounter(1).build(),
                Weather.newBuilder().setStation("SFO").setTime(2).setTemp(1).setCounter(1).build(),
        });
    }
}
